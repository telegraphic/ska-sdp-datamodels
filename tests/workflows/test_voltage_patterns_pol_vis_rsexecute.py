    ...
    def _test(self, time_range=None, flux=None, test_vp=False, name=""):
        ...
        for method in ["fft", "dft"]:
            ...
            if method == "dft":
                ...
                bvis_plot_list = predict_dft_rsexecute_workflow(
                    bvis_graph,
                    original_components,
                    gt_list=gt_list,
                ...
                bvis_plot_list = predict_fft_components_rsexecute_workflow(
                    bvis_graph,
                    original_components,
                    future_model_list,
                    vp_list=vp_list,
            ...
            plot_visibility_pol(
                ...
                title=name + " " + method,
                x="time",
                plot_file="{}/test_voltage_pattern_pol_rsexecute_amp_time_{}_{}.png".format(
            ...
            plot_visibility_pol(
                ...
                title=name + " " + method,
                x="uvdist",
                plot_file="{}/test_voltage_pattern_pol_rsexecute_amp_uvdist_{}_{}.png".format(
                    self.dir, name, method
                ),
            )
            ...
            plot_visibility_pol(
                ...
                x="uvdist",
                y="phase",
                plot_file="{}/test_voltage_pattern_pol_rsexecute_phase_uvdist_{}_{}.png".format(
                    self.dir, name, method
                ),
            )

    ...
    def test_create_low_test_beam(self):
        ...
        for i in [30, 40]:
            assert (
                numpy.max(
                    numpy.abs(
                        bm.data[0, 0, 128, 128 - 2 * i] - bm.data[1, 0, 128, 128 - i]
                    )
                )
                < 0.02
            )
            assert (
                numpy.max(
                    numpy.abs(
                        bm.data[0, 0, 128, 128 - 3 * i] - bm.data[2, 0, 128, 128 - i]
                    )
                )
                < 0.02
            )
            assert (
                numpy.max(
                    numpy.abs(
                        bm.data[0, 0, 128 - 2 * i, 128] - bm.data[1, 0, 128 - i, 128]
                    )
                )
                < 0.02
            )
            assert (
                numpy.max(
                    numpy.abs(
                        bm.data[0, 0, 128 - 3 * i, 128] - bm.data[2, 0, 128 - i, 128]
                    )
                )
                < 0.02
            )

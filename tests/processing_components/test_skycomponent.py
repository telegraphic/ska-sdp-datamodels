...
class TestSkyComponent(unittest.TestCase):
    ...
    def test_find_nearest_component_index(self):
        ...
        match = find_nearest_skycomponent_index(
            self.components[3].direction, self.components
        )
        assert match == 3
    ...
    def test_find_nearest_component(self):
        ...
        match, sep = find_nearest_skycomponent(
            self.components[3].direction, self.components
        )
    ...
    def test_select_neighbouring_components(self):
        ...
        indices, d2d = select_neighbouring_components(
            self.components, bright_components
        )

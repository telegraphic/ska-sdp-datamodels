...
class TestVisibilityDFTOperations(unittest.TestCase):
    def setUp(self):
        ...
        self.times = (numpy.pi / 43200.0) * numpy.arange(0.0, 300.0, 0.1)
        self.frequency = numpy.linspace(1.0e8, 1.1e8, 100)
        self.channel_bandwidth = numpy.array(nchan * [1e7])
        self.flux = numpy.repeat(numpy.array([100.0, 20.0, -10.0, 1.0]), nchan)

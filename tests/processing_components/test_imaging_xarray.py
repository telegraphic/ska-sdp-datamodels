...
from rascil.processing_components.image.image_x import convert_image_to_ximage
...
class TestImagingXarray(unittest.TestCase):
    def setUp(self):
    ...
    def actualSetUp(self, freqwin=1, block=True, dospectral=True,
        ...
        self.xvis = convert_blockvisibility_to_xvisibility(self.blockvis)
        self.xmodel = convert_image_to_ximage(self.model)

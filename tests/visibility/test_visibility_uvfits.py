...
from ska_sdp_func_python.visibility import integrate_visibility_by_channel

from ska_sdp_datamodels.science_data_model.polarisation_model import (
    PolarisationFrame,
)
from ska_sdp_datamodels.visibility.base import create_visibility_from_uvfits
...
class TestCreateMS(unittest.TestCase):
    ...
    def test_create_list_spectral(self):
        ...
        for schan in range(0, nchan, nchan_ave):
            ...
            v = create_visibility_from_uvfits(
